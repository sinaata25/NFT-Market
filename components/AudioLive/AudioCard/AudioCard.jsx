    ...
    return (
        <div className={Style.audioCard}>
            ...
            <div className={Style.audioCard_box_player}>
                <Image src={images.musiceWave} alt="musice" className={Style.audioCard_box_player_img_img} />
                <div className={Style.audioCard_box_musicPlayer} onClick={()=>playMusic()}>
                        {
                            play ? (<div className={Style.audioCard_box_musicPlayer_icon}>
                                <TbPlayerPause/>
                            </div>):
